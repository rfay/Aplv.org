 ...
 * @ingroup themeable
 */
function aplv2012d7_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function aplv2012d7_feed_icon($url) {
 ...
 */
function aplv2012d7_comment_wrapper($content, $type = null) {
  static $node_type;

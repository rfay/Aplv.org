...
function aplv2012d7_process_html(&$variables) {
...
function aplv2012d7_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function aplv2012d7_button($variables) {
 ...
 */
function aplv2012d7_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function aplv2012d7_menu_local_task($variables) {
 ...
 */
function aplv2012d7_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function aplv2012d7_node_preview($variables) {
  $node = $variables['node'];
